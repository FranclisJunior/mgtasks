...
import { MyListTableComponent } from './my-list-table/my-list-table.component';
import { MyTableLineComponent } from './my-table-line/my-table-line.component';
...
@NgModule({
  declarations: [
    AppComponent,
    MyListTableComponent,
    MyTableLineComponent
  ],
  imports: [
    CommonModule,
    BrowserModule,
